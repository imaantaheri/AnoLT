...
def process_file(file_path):
    ...
    # Compute Median and MAD per (Weekday, Time)
    ...
    test.dropna(subset=['Median', 'MAD'], inplace=True)
    ...
    for idx, label in enumerate(label_sets):
        ...
        best_result = None
        for c in c_values:
            upper = test['Median'] + c * test['MAD']
            lower = test['Median'] - c * test['MAD']
...
print("All files processed. Results being saved live to MAD-results.csv.")
