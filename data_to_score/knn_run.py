...
hyp_list = [n_neighbors, method, window_size]
...
for location in range(len(dir_list)):
    ...
    for hyp in range(len(combinations)):
        ...
        transformer = KNNSKI(n_neighbors = combinations[hyp][0],
                             method = combinations[hyp][1],
    ...
    with open('knn_results/' + dir_list[location][0:-4] + '.txt', mode='w') as file:
