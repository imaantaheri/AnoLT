...
hyp_list = [stop_epochs, k, window_size]
...
for location in range(len(dir_list)):
    ...
    for hyp in range(len(combinations)):
        ...
        transformer = Mo_GaalSKI(stop_epochs = combinations[hyp][0],
                                 k = combinations[hyp][1],
    ...
    with open('mo_gaal_results/' + dir_list[location][0:-4] + '.txt', mode='w') as file:
