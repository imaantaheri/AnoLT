...
hyp_list = [stop_epochs, window_size]
...
for location in range(len(dir_list)):
    ...
    for hyp in range(len(combinations)):
        ...
        transformer = So_GaalSKI(stop_epochs = combinations[hyp][0],
    ...
    with open('so_gaal_results/' + dir_list[location][0:-4] + '.txt', mode='w') as file:
