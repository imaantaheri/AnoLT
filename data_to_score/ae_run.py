...
neurons = [
            ...
            [4, [3, 2, 3]], [4, [3, 2, 1, 2, 3]],
            [5, [4, 3, 4]], [5, [4, 3, 2, 3, 4]],
            [7, [5, 4, 3, 4, 5]], [7, [5, 3, 5]], [7, [4, 3, 2, 3, 4]],
            [10, [7, 4, 7]], [10, [5, 4, 3, 4, 5]], [10, [5, 4, 3, 2, 3, 4, 5]]
            ]
...
for location in range(len(dir_list)):
    ...
    for hyp in range(len(combinations)):
        ...
        transformer = AutoEncoderSKI(hidden_neurons = combinations[hyp][0][1],
    ...
    with open('ae_results/' + dir_list[location][0:-4] + '.txt', mode='w') as file:
